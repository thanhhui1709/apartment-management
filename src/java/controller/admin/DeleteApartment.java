 ...
 * @author PC
 */
@WebServlet(name="DeleteApartment", urlPatterns={"/delete-apartment"})
public class DeleteApartment extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        ad.deleteApartment(id);
        request.getRequestDispatcher("view-apartment-admin").forward(request, response);
    } 
