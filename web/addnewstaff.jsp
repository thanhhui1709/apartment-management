                                ...
                                <div class="form-container">
                                    ...
                                    <form action="add-new-staff" method="post">
                                        <div class="form-group">
                                            <div class="two-cols">
                                                <div class="col" style="padding: 0; margin-right: 5px">
                                                    <label for="cccd">Citizen ID</label>
                                                    <input type="text" id="cccd" name="cccd" placeholder="Enter Citizen ID" required />
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="bank" name="bank" placeholder="Enter Bank" required />
                                        </div>    
                                        <div class="form-group">
