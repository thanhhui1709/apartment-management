                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-container">
                                    ...
                                    <form action="add-new-expenditure" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="approdate">Aprroveddate</label>
                                            <input type="date" id="approdate" name="approdate" required />
                                        </div>
                                        <div class="form-group">
                                            <label for="paydate">Paymentdate</label>
