            ...
            <div class="sidebar_blog_1">
                ...
                <div class="sidebar_user_info">
                    ...
                    <div class="user_profle_side">
                        <div class="user_img"><img class="img-responsive rounded-circle" src="${sessionScope.person.image == null ?'images/logo/person.jpg':sessionScope.person.image}" alt="#" /></div>
                        <div class="user_info">
